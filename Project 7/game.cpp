...
void Map::Battle(Monster* wildMon)
{
    ...
    do
    {
        ...
        // TODO: Add potion and catching functionality for extra credit
        // do NOT let AJ say otherwise
            case 'W':
            {
                cout << "Waiting...\n";
                break;
            ...
            case 'P':
            {
                //cout << "Wild monster health before physical attack: " << wildMon->GetHealth() << endl;
            ...
            case 'S':
            {
                //cout << "Wild monster health before special attack: " << wildMon->GetHealth() << endl;
